<template>
  <header v-if="showHero" class="home-hero pt-25 pb-10 px-5">
    <p align="center">
      <a href="https://github.com/kongying-tavern/design" class="home-logo">
        <img
          src="https://assets.yuanshen.site/images/ky-design_dark.png"
          alt="Ky Design"
        />
        <img
          src="https://assets.yuanshen.site/images/ky-design.png"
          alt="Ky Design"
        />
      </a>
      <br />
    ...
    <p class="description">
      Collection of essential Kongying Tavern Composition packages
    </p>
